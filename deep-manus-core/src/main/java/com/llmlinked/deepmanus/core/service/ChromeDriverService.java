 ...
 */
package com.llmlinked.deepmanus.core.service;

import com.llmlinked.deepmanus.core.config.BrowserProperties;
...
public class ChromeDriverService implements ApplicationRunner {
	...
	private ChromeDriver createNewDriver() {
		...
		try {
			...
			System.setProperty("webdriver.chrome.driver", "E:\\Projects\\IdeaProjects\\deep-manus\\deep-manus-starter\\src\\main\\resources\\data\\chromedriver.exe");
